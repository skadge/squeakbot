'From etoys4.0 of 9 October 2008 [dernière mise à jour: #2342] on 16 April 2011 at 5:44:18 pm'!Object subclass: #Arduino	instanceVariableNames: 'protocol digitalPins analogPins motorPins '	classVariableNames: ''	poolDictionaries: ''	category: 'Arduino-Core'!ArduinoPinMorph subclass: #ArduinoMotorPinMorph	instanceVariableNames: ''	classVariableNames: ''	poolDictionaries: ''	category: 'Arduino-Etoys'!AttachableDevice subclass: #DCMotor	instanceVariableNames: ''	classVariableNames: ''	poolDictionaries: ''	category: 'Arduino-Core-Devices'!OutputMode subclass: #DCMotorMode	instanceVariableNames: ''	classVariableNames: ''	poolDictionaries: ''	category: 'Arduino-Core-PinMode'!Smalltalk renameClassNamed: #MotorMorph as: #DCMotorMorph!AttachableDeviceMorph subclass: #DCMotorMorph	instanceVariableNames: ''	classVariableNames: ''	poolDictionaries: ''	category: 'Arduino-Etoys-Devices'!DCMotorMorph class	instanceVariableNames: ''!Object subclass: #SqueakBot	instanceVariableNames: ''	classVariableNames: 'DeviceIndex RegistredDevices'	poolDictionaries: ''	category: 'SqueakBot2'!Object subclass: #SqueakBotBitmapLibrary	instanceVariableNames: ''	classVariableNames: ''	poolDictionaries: ''	category: 'SqueakBot2'!!Arduino methodsFor: 'connection'!reconfigurePins	digitalPins values , analogPins values , motorPins values		do: [:t1 | t1 refresh]! !!Arduino methodsFor: 'accessing'!motorPin: t1 	^ motorPins		at: t1		ifAbsent: [self inaccessiblePinError]! !!Arduino methodsFor: 'initialize-release'!initialize	digitalPins := Dictionary				newFrom: ((2 to: 13)						collect: [:t1 | t1								-> (ArduinoDigitalPin on: protocol number: t1)]).	analogPins := Dictionary				newFrom: ((0 to: 5)						collect: [:t1 | t1								-> (ArduinoAnalogPin on: protocol number: t1)]).	motorPins := Dictionary				newFrom: ((1 to: 4)						collect: [:t1 | t1								-> (ArduinoDigitalPin on: protocol number: t1)])! !!ArduinoMorph methodsFor: 'motor pins'!isMotorPin1Active	^ (arduino motorPin: 1) isActive! !!ArduinoMorph methodsFor: 'motor pins'!motorPin1	^ [(arduino motorPin: 1) value]		on: Error		do: [-1]! !!ArduinoMorph methodsFor: 'initialize-release'!initializePins	| t1 |	t1 := 12 @ 125.	6		timesRepeat: [self				addMorph: (ArduinoPinMorph justASketch center: self center + t1).			t1 := t1 x + 13 @ t1 y].	t1 := 104 @ 125.	0		to: 5		do: [:t2 | 			self				addMorph: ((ArduinoAnalogPinMorph						on: (arduino analogPin: t2))						center: self center + t1).			t1 := t1 x + 13 @ t1 y].	t1 := -40 @ -124.	2		timesRepeat: [self				addMorph: (ArduinoPinMorph justASketch center: self center + t1).			t1 := t1 x + 13 @ t1 y].	t1 := -14 @ -124.	13		to: 8		by: -1		do: [:t2 | 			self				addMorph: ((ArduinoDigitalPinMorph						on: (arduino digitalPin: t2))						center: self center + t1).			t1 := t1 x + 13 @ t1 y].	t1 := 78 @ -124.	7		to: 2		by: -1		do: [:t2 | 			self				addMorph: ((ArduinoDigitalPinMorph						on: (arduino digitalPin: t2))						center: self center + t1).			t1 := t1 x + 13 @ t1 y].	t1 := 156 @ -124.	1		to: 0		by: -1		do: [:t2 | 			self				addMorph: (ArduinoPinMorph justASketch center: self center + t1).			t1 := t1 x + 13 @ t1 y].	self		addMorph: (ArduinoPinMorph justASketch center: self center).	self		addMorph: ((ArduinoMotorPinMorph				on: (arduino motorPin: 1))				center: self center + (13 @ 0))! !!ArduinoMotorPinMorph class methodsFor: 'as yet unclassified'!devices	| a |	a := Array new: 1.	a at: 1 put: DCMotorMorph.	^ a! !!AttachableDevicePlayer methodsFor: 'as yet unclassified'!getMode	^ self costume renderedMorph mode! !!AttachableDevicePlayer methodsFor: 'as yet unclassified'!setMode: t1 	^ self costume renderedMorph mode: t1! !!DCMotor methodsFor: 'as yet unclassified'!configure	pin mode: DCMotorMode new! !!DCMotor methodsFor: 'as yet unclassified'!deleteConfiguration	pin setOutput! !!DCMotor methodsFor: 'as yet unclassified'!initialize	super initialize! !!DCMotor methodsFor: 'as yet unclassified'!mode	^ pin value! !!DCMotor methodsFor: 'as yet unclassified'!mode: t1 	self controlAttaching; reconfigureIfNecessary.	pin		value: (t1 min: 3 max: 1)! !!DCMotorMode methodsFor: 'as yet unclassified'!nameSymbol	^ #dcmotor! !!DCMotorMode methodsFor: 'as yet unclassified'!refreshValue: t1 on: t2 using: t3 	t3 runMotor: t2 command: t1! !!DCMotorMorph methodsFor: 'as yet unclassified'!initialize	super initialize.	self extent: self class form extent! !!DCMotorMorph methodsFor: 'as yet unclassified'!mode	^ device mode! !!DCMotorMorph methodsFor: 'as yet unclassified'!mode: t1 	[device mode: t1]		on: Error		do: []! !!DCMotorMorph class methodsFor: 'as yet unclassified'!additionsToViewerCategories	^ #(#(#dcmotor #(#(#slot #mode '' #Number #readWrite #Player #getMode #Player #setMode:))) )! !!DCMotorMorph class methodsFor: 'as yet unclassified'!defaultNameStemForInstances	^ 'DC Motor'! !!DCMotorMorph class methodsFor: 'as yet unclassified'!descriptionForPartsBin	^ self		partName: 'DC Motor'		categories: {'Electronics'}		documentation: ''! !!DCMotorMorph class methodsFor: 'as yet unclassified'!device	^ DCMotor! !!DCMotorMorph class methodsFor: 'as yet unclassified'!initializeForm	^ form := PEUtilities formFromEncodedPNG: ''! !!Firmata methodsFor: 'servos'!runMotor: numMotor command: cmd 	self		runMotor: numMotor		command: cmd		speed: 100! !!Firmata methodsFor: 'servos'!runMotor: numMotor command: cmd speed: speed 	| t5 |	t5 := ByteArray new: 6.	t5 at: 1 put: FirmataConstants startSysex;		 at: 2 put: FirmataConstants shiftData;		 at: 3 put: numMotor;		 at: 4 put: cmd;		 at: 5 put: (speed * 2.5) rounded;		 at: 6 put: FirmataConstants endSysex.	self port nextPutAll: t5! !!FirmataConstants class methodsFor: 'message commands'!shiftData	^ 117! !!Flaps class methodsFor: '*SqueakBot2'!defaultsQuadsDefiningSqueakBotFlap	^ {{#ArduinoMorph. #openInWorld. 'Arduino' translated. 'Add an Arduino board' translated. SqueakBotBitmapLibrary arduinoIcon}} asOrderedCollection! !!Flaps class methodsFor: '*SqueakBot2'!initializeSqueakBotFlap	| t1 |	self registeredFlapsQuads		ifNil: [self initializeFlapsQuads].	SharedFlapTabs		ifNil: [self addAndEnableEToyFlaps].	self registeredFlapsQuads at: 'SqueakBot' put: self defaultsQuadsDefiningSqueakBotFlap.	t1 := self				newSqueakBotFlapFromQuads: self quadsDefiningSqueakBotFlap				positioning: #right				withPreviousEntries: nil.	t1 referent setNameTo: 'SqueakBot Flap' translated.	t1 hideFlap.	SharedFlapTabs add: t1.	self enableGlobalFlapWithID: 'SqueakBot' translated.	Preferences sugarNavigator		ifTrue: [(self globalFlapTabWithID: 'Sugar Navigator Flap' translated)				ifNotNilDo: [:t2 | t1 sugarNavTab: t2]]! !!Flaps class methodsFor: '*SqueakBot2'!newSqueakBotFlapFromQuads: t1 positioning: t2 withPreviousEntries: t3 	| t4 t5 t6 t7 |	t7 := Preferences sugarNavigator.	t5 := PartsBin				newPartsBinWithOrientation: #leftToRight				andColor: Color gray muchLighter				from: t1				withPreviousEntries: t3.	t4 := (t7				ifTrue: [SolidSugarSuppliesTab]				ifFalse: [FlapTab]) new referent: t5 beSticky.	t4		setName: 'SqueakBot' translated		edge: (t7				ifTrue: [#top]				ifFalse: [#bottom])		color: Color red lighter.	t4 position: 0 @ ActiveWorld sugarAllowance.	t4 setBalloonText: t4 balloonTextForFlapsMenu.	t4 applyThickness: 20.	t6 := ActiveWorld width.	t5 extent: ActiveWorld width @ (76 * (1 + (1350 // t6))).	t5 beFlap: true.	t5 autoLineLayout: true.	t7		ifTrue: [t4 useSolidTab.			t4 height: 20;								color: (Color						r: 0.804						g: 0.804						b: 0.804)]		ifFalse: [t4 color: Color red lighter].	^ t4! !!Flaps class methodsFor: '*SqueakBot2'!quadsDefiningSqueakBotFlap	^ self registeredFlapsQuadsAt: 'SqueakBot'! !!ProjectNavigationMorph methodsFor: '*SqueakBot2'!buttonSqueakBot	^ self		makeButton: 'SqueakBot' translated		balloonText: 'The robotic panel' translated		for: #toggleSqueakBot! !!SqueakBot class methodsFor: 'as yet unclassified'!initialize	SugarLibrary default iconAt: 'toggleSqueakBot' put: SqueakBotBitmapLibrary squeakBotIcon.	SugarNavigatorBar refreshButRetainOldContents.	Flaps initializeSqueakBotFlap! !!SqueakBotBitmapLibrary class methodsFor: 'as yet unclassified'!arduinoIcon	^ Form		extent: 60 @ 42		depth: 32		bits: (Base64MimeConverter mimeDecodeToBytes: '6dgVAAsKCGmH8whqiCr/CGuJD/8Uco7/MoOb/w1tiwr/B2uJF/8KaYX/El10/xJedv8SXXT/
...
Cv8AAAQP/wAAA/8AAAL/AAADCv8AAAQL/wAABf8AAAfipv8AAAg=' readStream) contents! !!SugarNavigatorBar methodsFor: 'help flap'!toggleHelp	PEUtilities openAboutWindow! !!SugarNavigatorBar methodsFor: '*SqueakBot2'!makeTheSimpleButtons	^ {self buttonHelp. self makeProjectNameLabel. self buttonPrev. self buttonNext. self buttonPaint. self buttonSqueakBot. self buttonSupplies} , {self buttonLanguage}		, (SugarLauncher isRunningInSugar				ifTrue: [{self buttonShare. #spacer. self buttonChoose. self buttonKeep. self buttonStop}]				ifFalse: [{self buttonZoom. #spacer. self buttonFind. self buttonPublish. self buttonQuit}])		, (Preferences navControlInNavBar				ifTrue: [{self buttonHideNavBar}]				ifFalse: [#()])! !!SugarNavigatorBar methodsFor: '*SqueakBot2'!toggleSqueakBot	| t1 t2 |	t2 := Flaps globalFlapTab: 'SqueakBot'.	t1 := t2 referent.	t1 isInWorld		ifTrue: [t2 hideFlap]		ifFalse: [t2 showFlap.			(owner notNil					and: [owner isFlapTab])				ifTrue: [owner edgeToAdhereTo == #top						ifTrue: [t1 position: self bottomLeft].					owner edgeToAdhereTo == #bottom						ifTrue: [t1 bottomLeft: self topLeft]]]! !SqueakBot initialize!DCMotorMorph class removeSelector: #form!DCMotorMorph class removeSelector: #isDigital!!ArduinoMorph reorganize!('motor pins' isMotorPin1Active motorPin1)('analog pins' analogPin0 analogPin1 analogPin2 analogPin3 analogPin4 analogPin5 isAnalogPin0Active isAnalogPin0Active: isAnalogPin1Active isAnalogPin1Active: isAnalogPin2Active isAnalogPin2Active: isAnalogPin3Active isAnalogPin3Active: isAnalogPin4Active isAnalogPin4Active: isAnalogPin5Active isAnalogPin5Active:)('accessing' boardType boardType: pinModeFromSymbol: portName portName: symbolFromPinMode:)('connection' connect disconnect isConnected)('initialize-release' delete initialize initializePins initializePortName newPlayerInstance)('digital pins' digitalPin10 digitalPin10Mode digitalPin10Mode: digitalPin10: digitalPin11 digitalPin11Mode digitalPin11Mode: digitalPin11: digitalPin12 digitalPin12Mode digitalPin12Mode: digitalPin12: digitalPin13 digitalPin13Mode digitalPin13Mode: digitalPin13: digitalPin2 digitalPin2Mode digitalPin2Mode: digitalPin2: digitalPin3 digitalPin3Mode digitalPin3Mode: digitalPin3: digitalPin4 digitalPin4Mode digitalPin4Mode: digitalPin4: digitalPin5 digitalPin5Mode digitalPin5Mode: digitalPin5: digitalPin6 digitalPin6Mode digitalPin6Mode: digitalPin6: digitalPin7 digitalPin7Mode digitalPin7Mode: digitalPin7: digitalPin8 digitalPin8Mode digitalPin8Mode: digitalPin8: digitalPin9 digitalPin9Mode digitalPin9Mode: digitalPin9: digitalPinModeAt: digitalPin:mode:)('drawing' drawOn:)('viewer category filter' filterViewerCategoryDictionary: validCategories wantsConnectionVocabulary wantsConnectorVocabulary wantsEmbeddingsVocabulary)('installing firmata' installFirmataIfPossible showProgressBar:forSeconds:while:)('as yet unclassified' isConnectable)('fileOut' prepareToBeSaved)!Object subclass: #Arduino	instanceVariableNames: 'protocol digitalPins analogPins motorPins'	classVariableNames: ''	poolDictionaries: ''	category: 'Arduino-Core'!